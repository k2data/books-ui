...
* Refactored sample bookShow constants and actions to their appropriate locations (thanks [kyleect](https://github.com/kyleect))
...
* Updates bookShow example to demonstrate `mapDispatchToProps`
...
#### Improvements
* Server no longer modifies initial bookShow state by default.
...
* Example store and view are now more intuitive (simple bookShow display).
