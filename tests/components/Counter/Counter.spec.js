...
describe('(Component) BookShow', () => {
  ...
  beforeEach(() => {
    ...
    _wrapper = shallow(<BookShow {..._props} />)
  })
  ...
  it('Should render with an <h2> that includes Sample BookShow text.', () => {
    expect(_wrapper.find('h2').text()).to.match(/BookShow:/)
  })
